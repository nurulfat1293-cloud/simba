...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-10">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <!-- Fitur Baru: Pencarian Cepat Kuota SBML Mitra -->
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden p-6">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-slate-400">Pilih nama mitra untuk melihat utilisasi kuota secara instan.</p>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div class="relative">
                        <select id="quickCheckMitra" class="w-full rounded-xl border-slate-200 py-3 px-4 text-sm font-medium focus:ring-2 focus:ring-indigo-500 transition-all cursor-pointer">
                            ...
                            @foreach($alert_sbml as $m)
                                <option value="{{ $m['nama'] }}" data-stats='@json($m)'>{{ $m['nama'] }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div id="quickEmpty" class="text-center py-4 bg-slate-50 rounded-xl border border-dashed border-slate-200">
                        <p class="text-[11px] text-slate-400 italic">Silakan pilih nama mitra dari daftar di atas.</p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    selectQuick.addEventListener('change', function() {
        ...
        const data = JSON.parse(option.getAttribute('data-stats'));
