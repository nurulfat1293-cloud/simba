        ...
        <form action="{{ route('spk.store') }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                @php
                    ...
                    // Mengubah koleksi mitra menjadi JSON array untuk Alpine.js

                    $mitraList = isset($mitra) ? $mitra->map(function($m) {
                ...
                <div>
                    ...
                    <div x-data="{
                        ...
                        init() {
                            ...
                            // Menangani label jika ada input lama (old input) setelah validasi gagal
                        ...
                        <!-- Input tersembunyi untuk dikirim melalui form -->
                        ...
                        >
                            ...
                            <span x-text="selectedLabel || '-- Cari Mitra (NIK / Nama) --'"></span>
