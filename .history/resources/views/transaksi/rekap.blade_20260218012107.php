                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex flex-col">
                                <h4 class="font-black text-slate-700 uppercase tracking-tighter text-sm flex items-center gap-2">
                                    ...
                                    {{-- PERBAIKAN: Mengganti @try/@catch dengan blok PHP standar --}}
                                    @php
                                        try {
                                            $formattedDate = \Carbon\Carbon::parse($bulanGroup)->locale('id')->translatedFormat('F Y');
                                        } catch (\Exception $e) {
                                            $formattedDate = $bulanGroup;
                                        }
                                    @endphp
                                    {{ $formattedDate }}
                                </h4>
