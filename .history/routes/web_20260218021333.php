...
Route::middleware('auth')->group(function () {
    ...
    // Perbaikan: Mengembalikan nama ke 'rekap.honor' agar sesuai dengan Sidebar (layout/app.blade.php)
    Route::get('/transaksi/rekap', [TransaksiController::class, 'rekap'])->name('rekap.honor');
