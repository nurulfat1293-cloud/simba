...
<head>
    ...
    <title>Cetak SPK - {{ $spk->nomor_spk ?? 'Preview' }}</title>
    ...
    <style>
        ...
        @media print {
            ...
            /* Reset Container agar tidak membatasi tinggi */
            .page-container { 
            ...
            /* PERBAIKAN UTAMA TABEL LAMPIRAN SAAT CETAK */
            .table-lampiran {
                width: 100% !important;
            ...
            /* Spasi Khusus Pasal 7 agar turun ke halaman baru jika terpisah */
            .break-pasal-7 {
        ...
        /* PERBAIKAN JARAK ANTAR PASAL & JUDUL KE ISI */
        .pasal-title {
            text-align: center;
            font-weight: bold;
            margin: 15px 0 0 0; /* Memberi jarak ke atas (antar pasal), tapi bawah 0 */
        }
        .pasal-title + p, 
        .pasal-title + ol {
            margin-top: 0 !important; /* Memaksa isi pasal nempel ke judulnya */
        }
    </style>
</head>
<body>
    ...
    <div class="page-container">
        <div class="text-center" style="margin-bottom: 20px; line-height: 1.15;">
            ...
            <h3 class="font-bold uppercase" style="margin:0; font-size:12pt;">PETUGAS PENDATAAN LAPANGAN</h3>
        ...
        <table class="table-data" style="margin-left: 0; width: 100%;">
            ...
            <tr>
                ...
                <td class="col-sep">:</td>
                <td class="col-desc">
                    Petugas Pendataan Lapangan berkedudukan di Desa {{ $desaMitra }}, Kecamatan {{ $kecMitra }}, bertindak untuk dan atas nama diri sendiri, selanjutnya disebut <strong>PIHAK KEDUA</strong>.
                </td>
            </tr>
        </table>

        <p style="margin-top: 15px;">
            bahwa <strong>PIHAK PERTAMA</strong> and <strong>PIHAK KEDUA</strong> yang secara bersama-sama disebut <strong>PARA PIHAK</strong>, sepakat untuk mengikatkan diri dalam Perjanjian Kerja Petugas Pendataan Lapangan pada {{ $namaSatkerProper }} Nomor: {{ $spk->nomor_spk }}, yang selanjutnya disebut Perjanjian, dengan ketentuan-ketentuan sebagai berikut:
        </p>

        <div class="pasal-title">Pasal 1</div>
        <p>
            <strong>PIHAK PERTAMA</strong> memberikan pekerjaan kepada <strong>PIHAK KEDUA</strong> and <strong>PIHAK KEDUA</strong> menerima pekerjaan dari <strong>PIHAK PERTAMA</strong> sebagai Petugas Pendataan Lapangan pada {{ $namaSatkerProper }}, dengan lingkup pekerjaan yang ditetapkan oleh <strong>PIHAK PERTAMA</strong>.
        </p>

        <div class="pasal-title">Pasal 2</div>
        <p>
            Ruang lingkup pekerjaan dalam Perjanjian ini mengacu pada wilayah kerja and beban kerja sebagaimana tertuang dalam Lampiran Perjanjian, Pedoman Petugas Pendataan Lapangan terkait kegiatan sebagaimana tertuang dalam Lampiran Perjanjian, and ketentuan-ketentuan lainnya yang ditetapkan oleh <strong>PIHAK PERTAMA</strong>.
        </p>
        ...
        <ol class="list-ayat">
            <li><strong>PIHAK KEDUA</strong> berkewajiban melaksanakan pekerjaan yang diberikan oleh <strong>PIHAK PERTAMA</strong> sesuai dengan ruang lingkup pekerjaan sebagaimana dimaksud dalam Pasal 2.</li>
            <li><strong>PIHAK KEDUA</strong> untuk waktu yang tidak terbatas and/atau tidak terikat kepada masa berlakunya Perjanjian ini, menjamin untuk memberlakukan sebagai rahasia setiap data/informasi yang diterima atau diperolehnya dari <strong>PIHAK PERTAMA</strong>, serta menjamin bahwa keterangan demikian hanya dipergunakan untuk melaksanakan tujuan menurut Perjanjian ini.</li>
        </ol>

        <div class="pasal-title">Pasal 5</div>
        <ol class="list-ayat">
            <li><strong>PIHAK KEDUA</strong> apabila melakukan peminjaman dokumen/data/aset milik <strong>PIHAK PERTAMA</strong>, wajib menjaga and menggunakan sesuai dengan tujuan perjanjian and mengembalikan dalam keadaan utuh sama dengan saat peminjaman, serta dilarang menggandakan, menyalin, menunjukkan, and/atau mendokumentasikan dalam bentuk foto atau bentuk apapun untuk kepentingan pribadi ataupun kepentingan lain yang tidak berkaitan dengan tujuan perjanjian ini.</li>
            <li><strong>PIHAK KEDUA</strong> dilarang memberikan dokumen/data/aset milik <strong>PIHAK PERTAMA</strong> yang berada dalam penguasaan <strong>PIHAK KEDUA</strong>, baik secara langsung maupun tidak langsung, termasuk memberikan akses kepada pihak lain untuk menggunakan, menyalin, memfotokopi, menunjukkan, and/atau mendokumentasikan dalam bentuk foto atau bentuk apapun, sehingga informasi diketahui oleh pihak lain untuk tujuan apapun.</li>
        </ol>
        ...
        <ol class="list-ayat">
            <li>
                ...
                ({{ terbilang($totalHonorPokok) }} Rupiah) untuk pekerjaan sebagaimana dimaksud dalam Pasal 2, termasuk biaya pajak, bea meterai, and jasa pelayanan keuangan.
            </li>
            <li>Honorarium sebagaimana dimaksud pada ayat (1) dibayarkan oleh <strong>PIHAK PERTAMA</strong> kepada <strong>PIHAK KEDUA</strong> setelah menyelesaikan seluruh pekerjaan yang ditargetkan sebagaimana tercantum dalam Lampiran Perjanjian ini, dituangkan dalam Berita Acara Serah Terima Hasil Pekerjaan, and diserahkan paling lambat tanggal {{ $tglBerakhir }}.</li>
            <li><strong>PIHAK KEDUA</strong> tidak diberikan honorarium tambahan apabila melakukan kunjungan di luar jadwal atau terdapat tambahan waktu pelaksanaan pekerjaan di luar jangka waktu Perjanjian sebagaimana dimaksud dalam Pasal 3, dengan tambahan waktu kunjungan atau tambahan waktu pelaksanaan pekerjaan paling lama sampai dengan tanggal {{ $tglBerakhir }}.</li>
        </ol>

        <div class="break-pasal-7">
            <div class="pasal-title">Pasal 7</div>
            <p>
                <strong>PIHAK KEDUA</strong> berhak untuk mendapatkan asuransi jaminan kecelakaan kerja (JKK) and jaminan kematian (JKM) dari <strong>PIHAK PERTAMA</strong> untuk jangka waktu pelaksanaan pendataan pada bulan {{ $bulanIndoAngka[(int)$spk->bulan] ?? '-' }} Tahun {{ $spk->tahun }}.
            </p>
        </div>

        <div class="pasal-title">Pasal 8</div>
        <ol class="list-ayat">
            <li>Pembayaran honorarium sebagaimana dimaksud dalam Pasal 6 dilakukan setelah <strong>PIHAK KEDUA</strong> menyelesaikan and menyerahkan hasil pekerjaan sebagaimana dimaksud dalam Pasal 2 kepada <strong>PIHAK PERTAMA</strong>.</li>
        ...
        <ol class="list-ayat">
            <li><strong>PIHAK PERTAMA</strong> secara berjenjang melalui Tim Teknis di {{ $namaSatkerProper }} melakukan pemeriksaan and evaluasi atas target penyelesaian and kualitas hasil pekerjaan yang dilaksanakan oleh <strong>PIHAK KEDUA</strong> secara berkala.</li>
            <li>Hasil pemeriksaan and evaluasi sebagaimana dimaksud pada ayat (1) menjadi dasar pembayaran honorarium <strong>PIHAK KEDUA</strong> oleh <strong>PIHAK PERTAMA</strong> sebagaimana dimaksud dalam Pasal 6 ayat (2), yang dituangkan dalam Berita Acara Serah Terima Hasil Pekerjaan yang ditandatangani oleh <strong>PARA PIHAK</strong>.</li>
        </ol>
        ...
        <ol class="list-ayat">
            <li>Apabila terjadi Keadaan Kahar, yang meliputi bencana alam, bencana non alam, and bencana sosial, <strong>PIHAK KEDUA</strong> memberitahukan kepada <strong>PIHAK PERTAMA</strong> dalam waktu paling lambat 14 (empat belas) hari sejak mengetahui atas kejadian Keadaan Kahar dengan menyertakan bukti.</li>
            <li>Apabila terjadi kerusakan perangkat pencacahan yang menyebabkan pelaksanaan pendataan lapangan tidak dapat dilakukan, <strong>PIHAK KEDUA</strong> melalui Petugas Pemeriksaan Lapangan memberitahukan kepada <strong>PIHAK PERTAMA</strong> dalam waktu paling lambat 14 (empat belas) hari kalender sejak terjadi kerusakan dimaksud.</li>
            <li>Dalam hal terjadi peristiwa sebagaimana dimaksud pada ayat (1) and/atau ayat (2), pelaksanaan pekerjaan oleh <strong>PIHAK KEDUA</strong> dihentikan sementara and dilanjutkan kembali setelah Keadaan Kahar berakhir, merujuk pada ketentuan yang ditetapkan oleh <strong>PIHAK PERTAMA</strong>.</li>
            <li>Apabila akibat Keadaan Kahar tidak memungkinkan dilanjutkan/diselesaikannya pelaksanaan pekerjaan, <strong>PIHAK KEDUA</strong> berhak menerima honorarium secara proporsional sesuai dengan pekerjaan yang telah diselesaikan and diterima oleh <strong>PIHAK PERTAMA</strong>.</li>
        </ol>

        <div class="pasal-title">Pasal 13</div>
        <p>
            Hal-hal yang belum diatur dalam Perjanjian ini atau segala perubahan terhadap Perjanjian ini diatur lebih lanjut oleh <strong>PARA PIHAK</strong> dalam perjanjian tambahan/adendum and merupakan bagian tidak terpisahkan dari Perjanjian ini.
        </p>
        ...
        <ol class="list-ayat">
            ...
            <li>Selama perselisihan dalam proses penyelesaian pengadilan, <strong>PIHAK PERTAMA</strong> and <strong>PIHAK KEDUA</strong> wajib tetap melaksanakan kewajiban masing-masing berdasarkan Perjanjian ini.</li>
        </ol>

        <p style="margin-top: 20px;">
            Demikian Perjanjian ini dibuat and ditandatangani oleh <strong>PARA PIHAK</strong> dalam 2 (dua) rangkap asli bermeterai cukup, tanpa paksaan dari PIHAK manapun and untuk dilaksanakan oleh <strong>PARA PIHAK</strong>.
        </p>
