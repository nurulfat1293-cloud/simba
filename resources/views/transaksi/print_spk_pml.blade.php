...
<head>
    ...
    <title>Cetak SPK PML - {{ $spk->nomor_spk ?? 'Preview' }}</title>
...
<body>
    ...
    <div class="page-container">
        <div class="text-center" style="margin-bottom: 20px; line-height: 1.15;">
            ...
            <h3 class="font-bold uppercase" style="margin:0; font-size:12pt;">PETUGAS PEMERIKSAAN/PENDATAAN LAPANGAN</h3>
        ...
        <table class="table-data" style="margin-left: 0; width: 100%;">
            ...
            <tr>
                ...
                <td class="col-sep">:</td>
                <td class="col-desc">
                    Petugas Pemeriksaan/Pendataan Lapangan berkedudukan di Desa {{ $desaMitra }}, Kecamatan {{ $kecMitra }}, bertindak untuk dan atas nama diri sendiri, selanjutnya disebut <strong>PIHAK KEDUA</strong>.
                </td>
            </tr>
        </table>

        <p style="margin-top: 15px;">
            bahwa <strong>PIHAK PERTAMA</strong> dan <strong>PIHAK KEDUA</strong> yang secara bersama-sama disebut <strong>PARA PIHAK</strong>, sepakat untuk mengikatkan diri dalam Perjanjian Kerja Petugas Pemeriksaan/Pendataan Lapangan pada {{ $namaSatkerProper }} Nomor: {{ $spk->nomor_spk }}, yang selanjutnya disebut Perjanjian, dengan ketentuan-ketentuan sebagai berikut:
        </p>

        <div class="pasal-title">Pasal 1</div>
        <p>
            <strong>PIHAK PERTAMA</strong> memberikan pekerjaan kepada <strong>PIHAK KEDUA</strong> dan <strong>PIHAK KEDUA</strong> menerima pekerjaan dari <strong>PIHAK PERTAMA</strong> sebagai Petugas Pemeriksaan/Pendataan Lapangan pada {{ $namaSatkerProper }}, dengan lingkup pekerjaan yang ditetapkan oleh <strong>PIHAK PERTAMA</strong>.
        </p>

        <div class="pasal-title">Pasal 2</div>
        <p>
            Ruang lingkup pekerjaan dalam Perjanjian ini mengacu pada wilayah kerja dan beban kerja sebagaimana tertuang dalam Lampiran Perjanjian, Pedoman Petugas Pemeriksaan/Pendataan Lapangan terkait kegiatan sebagaimana tertuang dalam Lampiran Perjanjian, dan ketentuan-ketentuan lainnya yang ditetapkan oleh <strong>PIHAK PERTAMA</strong>.
        </p>
        ...
        <div class="break-pasal-7">
            ...
            <p>
                <strong>PIHAK KEDUA</strong> berhak untuk mendapatkan asuransi jaminan kecelakaan kerja (JKK) dan jaminan kematian (JKM) dari <strong>PIHAK PERTAMA</strong> untuk jangka waktu pelaksanaan pendataan pada bulan {{ $bulanIndoAngka[(int)$spk->bulan] ?? '-' }} Tahun {{ $spk->tahun }}.
            </p>
        </div>
    ...
    <div class="page-container landscape landscape-section">
        <div class="header-lampiran text-left font-bold uppercase" style="font-size: 11pt; line-height: 1.5;">
            LAMPIRAN<br>
            PERJANJIAN KERJA<br>
            PETUGAS PEMERIKSAAN/PENDATAAN LAPANGAN<br>
