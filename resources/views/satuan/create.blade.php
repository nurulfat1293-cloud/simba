...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-2xl font-bold text-slate-800">Tambah Satuan Baru</h2>
            <p class="text-sm text-slate-500">Isi formulir berikut untuk menambahkan satuan kegiatan.</p>
        </div>
    </div>
